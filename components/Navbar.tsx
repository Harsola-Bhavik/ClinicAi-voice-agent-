  ...
  return (
    <nav className="bg-gradient-to-r from-slate-900 to-slate-800 text-white shadow-lg sticky top-0 z-50">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Mobile menu overlay */}
        {mobileMenuOpen && (
          <div className="md:hidden absolute left-0 right-0 top-16 bg-slate-900 bg-opacity-95 z-50 shadow-lg rounded-b-xl animate-fade-in flex flex-col items-center py-4 space-y-2 max-h-[70vh] overflow-y-auto">
            {auth?.currentUser ? (
              <>
                {auth.isAdmin() ? (
                  <>
